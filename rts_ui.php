...
<head>
    ...
    <title>Upload RTS Excel File</title>
...
<body>
    ...
    <div class="main-content">
        ...
        <div class="upload-container dashboard-card">
            ...
            <form id="uploadForm" action="rtsDataUpload.php" method="POST" enctype="multipart/form-data" class="upload-form d-flex gap-3 align-items-end">
            ...
            <a href="rtsTableView.php" class="view-records-btn mt-4">
